...
public class AStar2 {
	...
	public List<Vertex> computePaths(Vertex source, Vertex target ) {
		...
		if(obstaclesVertex.size()>0){
			for (Vertex obstacle : obstaclesVertex){
				obstacle.isObstacle=true;
			}
		}
		
//		Vertex obstacle= graph.getVertex(1721121174);
//		obstacle.isObstacle=true;
	...
	public void setObstaclesVertex(List<Vertex> obstaclesVertex) {
		this.obstaclesVertex = obstaclesVertex;
	}
